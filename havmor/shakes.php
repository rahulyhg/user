...
<body>
    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="cones.php">Cone</a>
    </div>
    <div class="container" id="main">
        <div class="row">
            <div>
                <h1 style="color: crimson;font-family: 'Satisfy', cursive; text-decoration: underline">Classic</h1>
            </div>
<?php
$res=mysqli_query($link,"select * from {$statement} where product_category='havmor'");
