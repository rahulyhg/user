...
<body>
    ...
    <div class="container" id="main">
        <div class="row">
            <div>
                <h1 style="color: crimson;font-family: 'Satisfy', cursive;">Block Buster Sticks</h1>
            </div>
<?php
$res=mysqli_query($link,"select * from {$statement} where product_category='sticks'");
...
?>			
            <div class="bg-primary card col-xs-6 col-sm-4 col-md-3 col-lg-2">
                ...
                <div class="container1">
                    <h4><?php echo $row["product_name"]; ?><p class="pre">f</p></h4>
