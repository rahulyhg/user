...
<body>
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        <li class="active">
          <a href="#">
            <img src="havmor.png" alt="logo" style="width: 100px; height: 30px; "></a>
        </li>
      </ul>
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <a href="sundaes.php">Sundaes</a>
    <a href="#">Cone</a>
  </div>
  <div class="container" id="main">
    <div class="row">
        <div>
            <h1 style="color: crimson;font-family: 'Satisfy', cursive; text-decoration: underline">Cones</h1>
        </div>
<?php
$res=mysqli_query($link,"select * from {$statement} where product_category='cones'");
