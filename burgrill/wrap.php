...
<div class="row">
<?php
$res=mysqli_query($link,"select * from {$statement} where product_category='wrap_nv'");
...
<div class="row">
<?php
$res=mysqli_query($link,"select * from {$statement} where product_category='wrap_veg'");
while($row=mysqli_fetch_array($res))
{
?>
      <div class="bg-primary card col-xs-6 col-sm-4 col-md-3 col-lg-2">
