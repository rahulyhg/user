...
<body> 
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        <li class="active">
          <a href="#">
            <img src="./chaat.jpg" alt="logo" style="width:30px;height:30px;">Pandit Ji</a>
        </li>
      </ul>
  ...
  <img src="./chaat.jpg" style="float:left; margin-left:470px; width:8%; height:8%;"/>
<h1 style="margin-right:470px">Pandit Ji</h1>
<p id="logo1" style="margin-right:470px">EAT.MEET.GREET</p>
<hr>
<div class="container" id="main">
<div class="row">
<?php
$res=mysqli_query($link,"select * from {$statement} where product_category='pandit'");
